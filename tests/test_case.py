#!/usr/bin/env python
# -*- coding: utf-8 -*-
# This file si ported from python-msgpack by INADA Naoki.
# See http://pypi.python.org/pypi/msgpack-python/
...
def test_match():
    cases = [
        ...
        (tuple(range(16)),
         "\xdc\x00\x10\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"),
        ({}, '\x80'),
